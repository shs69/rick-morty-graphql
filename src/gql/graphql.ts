...
export type GetFirstCharacterQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type GetFirstCharacterQuery = { character: { __typename: 'Character', image: string | null, name: string | null, status: string | null, species: string | null, location: { __typename: 'Location', name: string | null } | null, episode: Array<{ __typename: 'Episode', name: string | null } | null> } | null };
